...
## ITO film
I ordered mine from taobao with proxy service to Europe, but found similar option on aliexpress so go with whatever suits you better. ~~[Here is link to one i bought from tabao](https://m.tb.cn/h.5OVbLeX?tk=HFfzWfSNlO3)~~ link dead . Main thing you are looking for is 1 square meter, with applied glue on one side. About resistance, I have no clue that it changes but i went with 150ohm. 
